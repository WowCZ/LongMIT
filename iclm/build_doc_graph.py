...
from faiss_knn.offline_ivf import OfflineIVF
import faiss
...
def launch_job(
    ...
    if args.cluster_run:
        ...
        if args.slurm_constraint:
            executor.update_parameters(slurm_constraint=args.slurm_constraint)
...
if __name__ == "__main__":
    ...
    add_group_args(
        ...
        "--logs_dir",
        type=str,
        default="/fs-computility/llm/chenzhi/in-context-pretraining/output/offline_ivf_logs",
        help="cluster job name",
    )
